...
function animate(){
    ...
    // .to(default1,.1,{opacity:0})
    // .to([sheen1,sheen2,sheen3],.1,{opacity:0},0)

    
    // .from(copy0_2x,1,{ease:Quart.easeOut,opacity:0,y:10},"+=1")
    // .staggerFrom([copy1_2x,copy2_2x,copy3_2x,copy4_2x],.7,{ease:Cubic.easeOut,opacity:0,y:-20},.5,"+=.2")

    .from(cta_2x,.5,{opacity:0,x:5},"+=2")
    .fromTo(cta_arrow_2x,.5,{opacity:0,x:0},{opacity:1,x:4})
    .to(cta_arrow_2x,.33,{x:0})

    .to([sheen1,sheen2,sheen3],.1,{opacity:.9})
    .fromTo(sheen1,.3,{x:-50,ease:Quad.easeOut},{x:100,ease:Quad.easeIn},"sh")
    .fromTo(sheen2,.8,{x:-75,ease:Quad.easeOut},{x:100,ease:Quad.easeIn},"sh")
    .fromTo(sheen3,.3,{x:-50,ease:Quad.easeOut},{x:130,ease:Quad.easeIn},"sh+=1")
    .to([sheen1,sheen2,sheen3],.1,{opactiy:0})
